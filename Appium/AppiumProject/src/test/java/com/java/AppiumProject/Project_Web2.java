...
//		MobileElement el = driver.findElement(MobileBy.AndroidUIAutomator("UiScrollable(UiSelector().scrollable(true)).scrollForward().scrollIntoView(text(\"Tab Opener\"))"));
		...
		try {
			el = driver.findElement(MobileBy.AndroidUIAutomator(
					"UiScrollable(UiSelector().scrollable(true)).flingToEnd(10).scrollIntoView(text(\"Login Form\"))"));
		} catch (Exception e) {
			el = driver.findElement(MobileBy.AndroidUIAutomator(
					"UiScrollable(UiSelector().scrollable(true)).scrollForward().scrollIntoView(text(\"Login Form\"))"));

		}
		wait(5);

		driver.findElementByXPath("//android.view.View[contains(@content-desc,\"Login Form\")]/android.view.View[1]")
				.click();
